...
def extract_links(message):
    try: return re.findall(r'https?://\S+', message)
    except Exception as e: print(f"Error extracting links: {e}"); return []
        
def check_url_patterns(url: str):
    """
...
def get_formatted_size(size_bytes: int):
    """
...
async def is_user_on_chat(bot: TelegramClient, chat_id: int, user_id: int):
    """
...
def download_image_to_bytesio(url: str, filename: str):
    """
